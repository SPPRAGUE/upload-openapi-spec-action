...
## [1.0.0](https://github.com/SPPRAGUE/upload-openapi-spec-action/compare/v1.13.2...v1.0.0) (2026-04-02)
...
* a couple small tweaks ([#202](https://github.com/SPPRAGUE/upload-openapi-spec-action/issues/202)) ([0e2a297](https://github.com/SPPRAGUE/upload-openapi-spec-action/commit/0e2a2973686c4c408f58aacc1f14dbcf75ebd02b))
* add action to combine multiple OpenAPI specs ([#158](https://github.com/SPPRAGUE/upload-openapi-spec-action/issues/158)) ([a5690fa](https://github.com/SPPRAGUE/upload-openapi-spec-action/commit/a5690fa951806486720f35328b5b7555ec2836f1))
...
* add support for github OIDC auth ([#133](https://github.com/SPPRAGUE/upload-openapi-spec-action/issues/133)) ([259674c](https://github.com/SPPRAGUE/upload-openapi-spec-action/commit/259674c1b3969916062cf7ffe7e05ac4305ba9dd))
...
* assume checks are skipped if they do not start for a while ([#194](https://github.com/SPPRAGUE/upload-openapi-spec-action/issues/194)) ([aa5abca](https://github.com/SPPRAGUE/upload-openapi-spec-action/commit/aa5abca0203e13c99cbf126523f4029f707e68c2))
...
* **build:** combine build, preview, and merge ([efa0f49](https://github.com/SPPRAGUE/upload-openapi-spec-action/commit/efa0f49c5cf79aec15452e15bc71412fbd7b4452))
...
* check org-level enable_ai_commit_messages field ([#152](https://github.com/SPPRAGUE/upload-openapi-spec-action/issues/152)) ([90deb1b](https://github.com/SPPRAGUE/upload-openapi-spec-action/commit/90deb1bcc4b5bd0d72407720066c9d73bbe6823e))
...
* **compat:** add more details to ctx ([9d434fc](https://github.com/SPPRAGUE/upload-openapi-spec-action/commit/9d434fc769bded2cd620856508811787c3e5303a))
...
* correct stainless config name ([feab7f6](https://github.com/SPPRAGUE/upload-openapi-spec-action/commit/feab7f6ad3f42381946ba40191cea694439d68ea))
...
* handle case where there is a fatal error in the base build but not the head ([#205](https://github.com/SPPRAGUE/upload-openapi-spec-action/issues/205)) ([68b8589](https://github.com/SPPRAGUE/upload-openapi-spec-action/commit/68b8589f74d8378037f36e7cb5a81a1d01d7e920))
...
* **preview:** add output documented_spec_path to preview action ([#135](https://github.com/SPPRAGUE/upload-openapi-spec-action/issues/135)) ([5e80cc4](https://github.com/SPPRAGUE/upload-openapi-spec-action/commit/5e80cc40da2419877875629e10f67dfc92a95fb8))
* **preview:** add output_dir input and write documented spec to file ([#137](https://github.com/SPPRAGUE/upload-openapi-spec-action/issues/137)) ([d30490c](https://github.com/SPPRAGUE/upload-openapi-spec-action/commit/d30490c89b9a7fd667f9ab30678a332c00cd0d98))
* refactor outcome logic ([#189](https://github.com/SPPRAGUE/upload-openapi-spec-action/issues/189)) ([cec1106](https://github.com/SPPRAGUE/upload-openapi-spec-action/commit/cec11060b292826e929d94a08379ffbb86317299))
* remove token input ([f6a8d3a](https://github.com/SPPRAGUE/upload-openapi-spec-action/commit/f6a8d3ace736fdd100448423b9e2a6b2c811e297))
...
* show url for in progress ci steps ([#200](https://github.com/SPPRAGUE/upload-openapi-spec-action/issues/200)) ([e20dd9c](https://github.com/SPPRAGUE/upload-openapi-spec-action/commit/e20dd9c7dcf6446dd07de798896812ff2d5c52ce))
* support AI commit message generation for preview builds ([#143](https://github.com/SPPRAGUE/upload-openapi-spec-action/issues/143)) ([7010edb](https://github.com/SPPRAGUE/upload-openapi-spec-action/commit/7010edb3895df8fdb2f6e1f5b78613ffb8cd58ad))
* support per-SDK commit messages in preview comments ([#142](https://github.com/SPPRAGUE/upload-openapi-spec-action/issues/142)) ([a36c33f](https://github.com/SPPRAGUE/upload-openapi-spec-action/commit/a36c33fc218bd12e52b4ad01bf00d02748894f2e))
...
* Update to latest @stainless-api/sdk ([#144](https://github.com/SPPRAGUE/upload-openapi-spec-action/issues/144)) ([a9b388b](https://github.com/SPPRAGUE/upload-openapi-spec-action/commit/a9b388bdeda07821deadf90e4ad4818d5776498f))
...
* use severity as conclusion for diagnostic/check step cases ([#198](https://github.com/SPPRAGUE/upload-openapi-spec-action/issues/198)) ([224c0e1](https://github.com/SPPRAGUE/upload-openapi-spec-action/commit/224c0e1fa6641945612f9f9eb0b11e01b22560b3))
...
* accept multiline conventional commits ([#129](https://github.com/SPPRAGUE/upload-openapi-spec-action/issues/129)) ([d2dcc0b](https://github.com/SPPRAGUE/upload-openapi-spec-action/commit/d2dcc0b3bfb698840cdc0b3bf52a28ac4e65bc55))
* add refresh for OIDC token ([#165](https://github.com/SPPRAGUE/upload-openapi-spec-action/issues/165)) ([9b04055](https://github.com/SPPRAGUE/upload-openapi-spec-action/commit/9b04055f28435f279a9ea7a7070dcbeabb56ff2a))
* allow multi-line conventional commits ([#177](https://github.com/SPPRAGUE/upload-openapi-spec-action/issues/177)) ([0079085](https://github.com/SPPRAGUE/upload-openapi-spec-action/commit/0079085539102bb10b95abbdd3652b72ccb4a83d))
...
* **build:** don't merge if no merge branch ([#201](https://github.com/SPPRAGUE/upload-openapi-spec-action/issues/201)) ([650b38c](https://github.com/SPPRAGUE/upload-openapi-spec-action/commit/650b38c5349ad56bbe1828be8f4c19177dbda222))
* catch guesser errors ([#211](https://github.com/SPPRAGUE/upload-openapi-spec-action/issues/211)) ([85f07c6](https://github.com/SPPRAGUE/upload-openapi-spec-action/commit/85f07c68c3e04d0237647300f884b1b9983aed75))
* catch more expected getPullRequestForCommit errors ([#217](https://github.com/SPPRAGUE/upload-openapi-spec-action/issues/217)) ([30a19a7](https://github.com/SPPRAGUE/upload-openapi-spec-action/commit/30a19a747712b69ce39444e554d7ddd95f79c65a))
...
* **comment:** add install instructions for java, cli ([#171](https://github.com/SPPRAGUE/upload-openapi-spec-action/issues/171)) ([9f22f23](https://github.com/SPPRAGUE/upload-openapi-spec-action/commit/9f22f23be86aa881a863eea93a699871f39df0e8))
...
* **deps:** update dependency fs-extra to v11.3.0 ([#57](https://github.com/SPPRAGUE/upload-openapi-spec-action/issues/57)) ([61e1b43](https://github.com/SPPRAGUE/upload-openapi-spec-action/commit/61e1b432e84084e2d5220b1cc9987322d2a8171d))
...
* fix display for pending results ([#179](https://github.com/SPPRAGUE/upload-openapi-spec-action/issues/179)) ([89af7c3](https://github.com/SPPRAGUE/upload-openapi-spec-action/commit/89af7c3871f904027141077b9e3afb88f60bb5e4))
* fix gitlab client usage ([#196](https://github.com/SPPRAGUE/upload-openapi-spec-action/issues/196)) ([3fe4697](https://github.com/SPPRAGUE/upload-openapi-spec-action/commit/3fe4697ea14e60c015fd1977761ba49afacb5ae1))
...
* improve getMergeBase to handle shallow clones more robustly ([#138](https://github.com/SPPRAGUE/upload-openapi-spec-action/issues/138)) ([3687845](https://github.com/SPPRAGUE/upload-openapi-spec-action/commit/3687845465214a98c1f18a48600f6a8c7cf60561))
...
* re-enable 'targets' param in diagnostics call ([#148](https://github.com/SPPRAGUE/upload-openapi-spec-action/issues/148)) ([3130e17](https://github.com/SPPRAGUE/upload-openapi-spec-action/commit/3130e17c92819fd08f6aded35d243975c4e8404c))
...
* refresh token in fetch if needed ([#169](https://github.com/SPPRAGUE/upload-openapi-spec-action/issues/169)) ([62540f2](https://github.com/SPPRAGUE/upload-openapi-spec-action/commit/62540f26f52c69d8e82f6ce4366e05544f3d13ab))
...
* revert refresh for OIDC token ([#167](https://github.com/SPPRAGUE/upload-openapi-spec-action/issues/167)) ([8229a89](https://github.com/SPPRAGUE/upload-openapi-spec-action/commit/8229a8959722956693e0abc53fdf155ed642bddd))
...
* save and reapply config patch instead of whole config ([#172](https://github.com/SPPRAGUE/upload-openapi-spec-action/issues/172)) ([15947cf](https://github.com/SPPRAGUE/upload-openapi-spec-action/commit/15947cf20f36b6b7024ee059d587951eda7091c9))
* save config in merge action (and add more logging) ([#163](https://github.com/SPPRAGUE/upload-openapi-spec-action/issues/163)) ([9f0a042](https://github.com/SPPRAGUE/upload-openapi-spec-action/commit/9f0a0426cc59606833d37c1f50f6029ec1991837))
* slightly different polling termination condition ([#208](https://github.com/SPPRAGUE/upload-openapi-spec-action/issues/208)) ([319cfc9](https://github.com/SPPRAGUE/upload-openapi-spec-action/commit/319cfc9d3522edacb70de93393c572bcdbdf15ac))
* sort regressions first when determining worst outcome ([#214](https://github.com/SPPRAGUE/upload-openapi-spec-action/issues/214)) ([202724b](https://github.com/SPPRAGUE/upload-openapi-spec-action/commit/202724b6cc35cd15f1b0188f70397387645b73ff))
...
* throw if path is given but not found ([#115](https://github.com/SPPRAGUE/upload-openapi-spec-action/issues/115)) ([dfedffa](https://github.com/SPPRAGUE/upload-openapi-spec-action/commit/dfedffaec97d7317ad1f2af53ae83f97c3a113dd))
...
* tweak categorizeOutcomes ([#132](https://github.com/SPPRAGUE/upload-openapi-spec-action/issues/132)) ([c45d6a9](https://github.com/SPPRAGUE/upload-openapi-spec-action/commit/c45d6a9c7996dea81cf770649e24846756d463cc))
...
* url encode branch names ([#199](https://github.com/SPPRAGUE/upload-openapi-spec-action/issues/199)) ([dfe83db](https://github.com/SPPRAGUE/upload-openapi-spec-action/commit/dfe83dbdfebbd020fc604e9f8c28c2cdcac93ade))
...
* yaml formatting ([c9df677](https://github.com/SPPRAGUE/upload-openapi-spec-action/commit/c9df67766188af19676071bb5d44b6ef7da26cfd))
